...
@JsonPropertyOrder({"resourceScheduleId", "eventId", "eventSubscriptionId", "eventReference",
               "eventType",   "facilityReference", "eventDay", "eventMonth", "eventYear",  "eventStartTime",
                   "eventEndTime", "resourceEventSubscriptionId", "resourceEventReference" })
